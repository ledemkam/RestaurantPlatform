...
export default function Home() {
  ...
  const [currentSearchParams, setCurrentSearchParams] = useState<RestaurantSearchParams>({});

  const searchRestaurants = async (params: RestaurantSearchParams, targetPage?: number) => {
    try {
      setLoading(true);
