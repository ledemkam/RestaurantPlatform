...
const getImage = (restaurant: RestaurantSummary) => {
  if (restaurant.photos && null != restaurant.photos[0] && null != restaurant.photos[0].url) {
        ...
        <div className="p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{restaurant.address.city}, {restaurant.address.country}</p>
            </div>
          </div>
